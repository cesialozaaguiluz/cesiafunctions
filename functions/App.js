...
//
 ...
 {number === 1?<View style={styles.container2}>
    ...
    {number === 4?<View style={styles.container}>
      <Text style={styles.paragraphteal}>
        Music
      </Text>
    </View> :null}
    {number === 4?<View style={styles.container2}>
    <Image
    ...
    {number === 5?<View style={styles.container}>
      <Text style={styles.paragraphpurple}>
        Business
      </Text>
    </View> :null}
    {number === 5?<View style={styles.container2}>
    <Image
    ...
    {number === 5? <View style={styles.container3}>
      <Text style={styles.paragraphpurple}>
